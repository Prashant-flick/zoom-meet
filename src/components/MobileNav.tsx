    ...
    >
        <Sheet>
            ...
            <SheetContent side="left" className='bg-dark-1 border-none'>
              ...
              <div
                className='flex flex-col h-[calc(100vh - 72px)] overflow-y-auto justify-between'
              >
                <SheetClose
                  className='flex flex-col h-full gap-6 pt-16 text-white'
                >
                    ...
                    return (
                      <SheetClose asChild key={link.route}>
                        <Link
                          href={link.route}
                          key={link.label}
                          className={cn('flex gap-4 items-center p-4 h-14 rounded-lg w-full max-w-60', {
                            'bg-blue-1': isActive
                          })}
                        >
                          <Image
